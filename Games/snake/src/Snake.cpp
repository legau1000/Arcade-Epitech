...
namespace gameModule
{
	...
	{
		switch (evt) {
            case displayModule::e_event::KEY_Z : this->_move = TOP;
            case displayModule::e_event::KEY_S : this->_move = BOT;
            case displayModule::e_event::KEY_Q : this->_move = LEFT;
            case displayModule::e_event::KEY_D : this->_move = RIGHT;
            default:break;
        }
	}
