...
private:
  ...
  /*!
             ...
             */
  void gameOver(displayModule::e_event ext);
  /*!
             *  \brief Menu
             *
  ...
  /*!
             *  \brief Reload le jeu après avoir échoué.
             *
             *  Methode qui permet de reset toutes les valeurs à 0 pour pouvoir recommencer le jeu depuis le départ.
             */
  void restartGame();
